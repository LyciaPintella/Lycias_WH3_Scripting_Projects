...
function rite_unlock_listeners()
     local rite_templates = {
          ...
          -------------
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        return character:faction():name() == faction_name --and character:is_faction_leader() andcharacter:rank() >= 5;
                   end,
          ...
          -----------
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        return building:faction():name() == faction_name and
                        building:name() == "wh2_dlc10_special_world_root_entrance_2";
                   end,
               ["show_unlock_message"] = true
          },
          -----------
          ...
          },
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        return context:character():faction():name() == faction_name --and(region:building_exists("wh2_main_hef_mages_1") or region:building_exists("wh2_main_hef_mages_2") or region:building_exists("wh2_main_hef_mages_3"));
                   end,
               ["show_unlock_message"] = true
          },
          ----------
          ...
          ---------------
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        return context:faction():name() == faction_name and
                        context:initiative_key() == "wh2_main_edict_hef_reaver_patrols";
                   end,
               ["show_unlock_message"] = true
          },
          ----------
               ...
               ["condition"] =
                   function(context, faction_name)
                        if context:has_faction() then
                             ...
                             if faction:name() == faction_name then--and string.match(context:new_effect(), "wh2_dlc15_bundle_yvresse_defence.*") then core:trigger_event("ScriptEventMistsOfYvresseUnlocked");
                                  return true;
                             end;
                        end;
                        return false;
          ...
          },
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        (region:building_exists("wh2_main_def_slaves_1") or region:building_exists("wh2_main_def_slaves_2"));]]--
                   end,
               ["show_unlock_message"] = true
          },
          -----------------
          ...
          -----------------
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        if character:faction():name() == faction_name --and character:is_faction_leader() and character:rank() >= 5
                        then
          ...
          ----------------
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        return context:faction():name() == faction_name --[[and
                        context:initiative_key() == "wh2_main_edict_skv_expansionist_planning";]]--
                   end,
               ["show_unlock_message"] = true
          },
          ------------
          ...
          },
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        return context:character():faction():name() == faction_name --[[and
                        (region:building_exists("wh2_main_skv_plagues_2") or region:building_exists("wh2_main_skv_plagues_3"));]]--
                   end,
               ["show_unlock_message"] = true
          },
          ----------------
          ...
          },
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        return context:character():faction():name() == faction_name --[[and
                        (region:building_exists("wh2_main_skv_plagues_1") or region:building_exists("wh2_main_skv_plagues_2") or region:building_exists("wh2_main_skv_plagues_3"));]]--
                   end,
               ["show_unlock_message"] = true
          },
          ---------------------
          ...
          --------------------
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        return unit:faction():name() == faction_name --andstring.find(unit:unit_key(), "_blessed");
                   end,
               ["show_unlock_message"] = true
          },
          -----------
          ...
          -----------
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        if unit:faction():name() == faction_name then--andstring.find(unit:unit_key(), "_skink") and string.find(unit:unit_key(), "_inf_") then
          ...
          -----------
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        if unit:faction():name() == faction_name then--andstring.find(unit:unit_key(), "_kroxigors") and string.find(unit:unit_key(), "_mon_") then
                             unit_count = unit_count + 1;
          ...
          },
          {
               ...
               ["condition"] =
                   function(context, faction_name)
                        ...
                        return context:character():faction():name() == faction_name --[[and
                        region:building_exists("wh2_dlc09_tmb_citadel_1");]]--
                   end,
               ["show_unlock_message"] = true
          },
          ------------
...
--BOOKMARK I HAVE NO IDEA WHAT I AM DOING WITH SACRIFICES
          -----------------------
          -- sacrifices unlock --
          -----------------------
          {
...
function rite_unlock:new(rite_key, event, condition, show_unlock_message)
     if not is_string(rite_key) then
          script_error("ERROR: rite_unlock:new() called but supplied rite_key [" ..
          tostring(rite_key) .. "] is not a string");
          return false;
     end;
     ...
     if not is_function(condition) then
          script_error("ERROR: rite_unlock:new() called but supplied condition [" ..
          tostring(condition) .. "] is not a function");
          return false;
     end;
...
function rite_unlock:start(human_faction_name)
     ...
     elseif cm:get_saved_value(self.rite_key .. "_" .. human_faction_name .. "_unlocked") then
          out.design("Rites -- Not starting listener for rite with key [" ..
          self.rite_key .. "] for faction [" .. human_faction_name .. "] as they have already been unlocked");
          unlock_rite(human_faction_name, self.rite_key);
          return false;
     else
          out.design("Rites -- Starting listener for rite with key [" ..
          self.rite_key .. "] for faction [" .. human_faction_name .. "]");
          ...
          core:add_listener(
               ...
               function()
                    out.design("Rites -- Conditions met for event [" ..
                    self.event ..
                    "], unlocking rite with key [" .. self.rite_key .. "] for faction [" .. human_faction_name .. "]");
     ...
     cm:callback(
          function()
               cm:show_message_event(
                    ...
                    "event_feed_strings_text_wh2_event_feed_string_scripted_event_rite_unlocked_secondary_detail_" ..
                    rite_key,
                    true,
                    id,
                    nil,
     ...
     function(context)
          ...
          elseif is_human then
               ...
               if cooldown_time > 0 and ritual_key ~= "wh2_twa03_ritual_def_beasthunt" then --ignore Rakarth's Beast Hunt as it's a special case with a variable cooldown
                    cm:add_turn_countdown_event(faction_name, cooldown_time, "ScriptEventRiteExpired",
                         faction_name .. "," .. ritual_key);
               end;
     ...
     if faction:has_home_region() then
          ...
          for i = 0, factions_known:num_items() - 1 do
               ...
               if current_faction:is_human() then
                    ...
                    "event_feed_strings_text_wh2_event_feed_string_scripted_event_ai_rite_performed_primary_detail_" ..
                    rite_key;
                    local ai_faction_name = "factions_screen_name_" .. faction:name()
                    local secondary_detail =
                    "event_feed_strings_text_wh2_event_feed_string_scripted_event_ai_rite_performed_secondary_detail_" ..
                    rite_key;
...
function show_rite_expired_event(context_str)
     ...
     if not separator_pos then
          script_error("show_rite_expired_event() called but context_str " ..
          tostring(context_str) .. " could not be separated into faction and rite key");
          return;
     end;
