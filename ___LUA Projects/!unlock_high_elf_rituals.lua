...
function rite_unlock_listeners()
	local rite_templates = {
		...
		-------------
		{
			...
			["condition"] =
				function(context, faction_name)
					...
					return character:faction():name() == faction_name and true
				end,
		...
		-----------
		{
			...
			["condition"] =
				function(context, faction_name)
					...
					return building:faction():name() == faction_name and true
				end,
			["show_unlock_message"] = false
		},
		-----------
		...
		},
		{
			...
			["condition"] =
				function(context, faction_name)
					...
					return context:character():faction():name() == faction_name and true
				end,
			["show_unlock_message"] = false
		},
		----------
		...
		----------
		{
			...
			["condition"] =
				function(context, faction_name)
					...
					return faction:name() == faction_name and true
				end,
			["show_unlock_message"] = false
		},
		...
		---------------
		{
			...
			["condition"] =
			function(context, faction_name)
				return context:faction():name() == faction_name and true
			end,
			["show_unlock_message"] = false
		},
		----------
			...
			["condition"] =
				function(context, faction_name)
					if context:has_faction() then
						...
						if faction:name() == faction_name and true then
		...
		-----------------
		{
			...
			["condition"] =
				function(context, faction_name)
					...
					if character:faction():name() == faction_name and true then
		...
		--------------------
		{
			...
			["condition"] =
				function(context, faction_name)
					...
					return unit:faction():name() == faction_name and true
				end,
			["show_unlock_message"] = false
		},
		-----------
