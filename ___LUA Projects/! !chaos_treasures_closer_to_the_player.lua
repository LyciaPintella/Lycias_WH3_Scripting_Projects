...
function chaos_treasures()
     if items_poi_alt["wh3_main_freiya1"][3] == "false" then
          ...
          -- Check if it's an IE expanded or normal campaign and create coordinates/items list
          if cm:model():campaign_name_key() == "cr_combi_expanded" then
               ...
               treasure_list = {
                    ...
                    [8] = { "wh_main_anc_armour_armour_of_despair" }
               };
          else
               treasure_loc_all = {
                    [1] = { 60, 835 },
          ...
          if cm:model():campaign_name_key() == "cr_combi_expanded" then
               items_poi_alt = {
                    ...
                    ["wh3_main_freiya8"] = { treasure_loc_all[8][1], treasure_loc_all[8][2], treasure_list[8][1] }
               };
          else
               items_poi_alt = {
                    ["wh3_main_freiya1"] = { treasure_loc_all[1][1], treasure_loc_all[1][2], treasure_list[1][1] },
...
function generate_chaos_treasure_invasion(character, loc, turn)
     ...
     elseif turn > 4 and turn < 10 then
          army_size = 20
          -- E Tier
          ...
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_marauder_horsemen_mkho_throwing_axes",
               2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_marauder_horsemen_mnur_throwing_axes",
               2);
          ...
          -- Tier 3
     elseif turn > 9 and turn < 15 then
          army_size = 20
          -- D Tier
     ...
     elseif turn > 14 and turn < 20 then
          army_size = 20
          -- C Tier
     ...
     --invasion_1:add_character_experience(20, true)
