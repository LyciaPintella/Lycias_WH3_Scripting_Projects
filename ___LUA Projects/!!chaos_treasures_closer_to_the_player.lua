...
function chaos_treasures()
     if items_poi_alt["wh3_main_freiya1"][3] == "false" then
          ...
          table.sort(treasure_loc_all, function(a, b) return a[3] < b[3]; end);
     ...
     -- If it's more than turn 1, just spawn all the treasures, otherwise wait for the turn 2 to happen
     ...
     if turn_count > 5 then
          ...
          -- Wait for the turn 6
          core:add_listener("chaos_treasure_listen", "WorldStartRound", true, function()
               ...
               if turn_count == 6 then
                    ...
                    for i = 1, #player_factions do
                         cm:show_message_event(player_factions[i],
                                               "event_feed_strings_text_wh_event_feed_string_scripted_event_freiya_chaos_treasure_expanded_title", "",
                                               "event_feed_strings_text_wh_event_feed_string_scripted_event_freiya_chaos_treasure_expanded_description", true, 165);
                    end
               end
          end, true);
     end
...
core:add_listener("chaos_treasure_marker", "AreaEntered", function(context)
     local character = context:family_member():character();
     return not character:is_null_interface() and context:area_key():starts_with("wh3_main_freiya") and cm:char_is_general_with_army(character);
end, function(context)
     local character = context:family_member():character();
     local faction = character:faction();

     -- Only the player and lords can get the treasures
     if character:is_null_interface() or not character:has_military_force() or not faction:is_human() then return; end
     ...
     dilemma_triggered = cm:trigger_dilemma_with_targets(faction_cqi, "wh3_dilemma_chaos_treasures", faction_cqi, 0, character:command_queue_index(),
                                                         mf:command_queue_index(), 0, 0);

     if dilemma_triggered then
          core:add_listener("dilemma_choice_made_event_trigger_chaos_treasure_incident", "DilemmaChoiceMadeEvent", true, function(context)
               local dilemma = context:dilemma();
               local choice = context:choice();

               if choice == 0 then
                    local x, y = cm:find_valid_spawn_location_for_character_from_position(faction:name(), items_poi_alt[area_key][1], items_poi_alt[area_key][2],
                                                                                          false);
...
core:add_listener("chaos_treasure_postbattle_cleanup", "BattleCompleted", function() return cm:get_saved_value("chaos_treasure_battle_active"); end, function()
...
function generate_chaos_treasure_invasion(character, loc, turn)
     ...
     if turn < 6 then
          army_size = 16
          -- E Tier
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_inf_chaos_marauders_0", 15);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_inf_chaos_marauders_1", 15);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_marauders_mnur_greatweapons", 5);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_marauders_msla_hellscourges", 5);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_marauders_mnur", 5);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_marauders_msla", 5);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_inf_marauders_0", 3);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_inf_marauders_1", 3);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_inf_marauders_2", 3);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_inf_nurglings_0", 3);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_dae_inf_chaos_furies_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_inf_chaos_furies_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_inf_chaos_furies_0", 2);

          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_marauder_horsemen_msla_javelins", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_cav_marauder_horsemen_1", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_cav_marauder_horsemen_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_cav_hellstriders_0", 2);

          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_mon_chaos_warhounds_0", 3);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_mon_chaos_warhounds_1", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_mon_plague_toads_0", 2);
     elseif turn > 5 and turn < 11 then
          army_size = 16
          -- E Tier
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_inf_chaos_marauders_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_inf_chaos_marauders_1", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_marauders_mkho_dualweapons", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_marauders_mtze_spears", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_marauders_mkho", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_marauders_mtze", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_tze_inf_blue_horrors_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_kho_inf_chaos_warhounds_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_dae_inf_chaos_furies_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_kho_inf_chaos_furies_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_tze_inf_chaos_furies_0", 1);

          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_marauder_horsemen_mtze_javelins", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_cav_marauder_horsemen_1", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_cav_marauder_horsemen_0", 1);

          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_mon_chaos_warhounds_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_mon_chaos_warhounds_1", 1);

          -- D Tier
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_inf_chaos_warriors_0", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_warriors_mtze", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_inf_chaos_warriors_1", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc01_chs_inf_chaos_warriors_2", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_kho_inf_bloodletters_0", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_kho_inf_chaos_warriors_0", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_tze_inf_pink_horrors_0", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc01_chs_inf_forsaken_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_forsaken_mkho", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_tze_inf_forsaken_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_kho_inf_flesh_hounds_of_khorne_0", 2);

          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc06_chs_cav_marauder_horsemasters_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_marauder_horsemen_mkho_throwing_axes", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_marauder_horsemen_mnur_throwing_axes", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_cav_chaos_chariot", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_chaos_chariot_mkho", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_chaos_chariot_mtze", 2);

          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc06_chs_feral_manticore", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_mon_trolls", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_mon_chaos_spawn", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_tze_mon_screamers_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_tze_mon_flamers_0", 2);

          -- Tier 3
     elseif turn > 10 and turn < 16 then
          army_size = 17
          -- D Tier
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_inf_chaos_warriors_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_warriors_mnur", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_warriors_msla", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_inf_chaos_warriors_1", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc01_chs_inf_chaos_warriors_2", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_inf_plaguebearers_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_inf_daemonette_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc01_chs_inf_forsaken_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_forsaken_mkho", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_forsaken_msla", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_inf_forsaken_0", 1);

          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc06_chs_cav_marauder_horsemasters_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_marauder_horsemen_mkho_throwing_axes", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_marauder_horsemen_mnur_throwing_axes", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_cav_chaos_chariot", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_chaos_chariot_mnur", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_cav_chaos_chariot_msla", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_cav_hellstriders_1", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_cav_plague_drones_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_veh_seeker_chariot_0", 1);

          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc06_chs_feral_manticore", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_mon_trolls", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_mon_chaos_spawn", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_mon_beast_of_nurgle_0", 1);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_mon_rot_flies_0", 1);

          -- C Tier
          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc06_chs_inf_aspiring_champions_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_warriors_mnur_greatweapons", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_inf_chaos_warriors_msla_hellscourges", 6);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_inf_plaguebearers_1", 6);

          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc01_chs_cav_gorebeast_chariot", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_cav_seekers_of_slaanesh_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_cav_pox_riders_of_nurgle_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_veh_hellflayer_0", 2);

          random_army_manager:add_unit("chaos_treasure_force", "wh3_dlc20_chs_mon_warshrine", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh_dlc01_chs_mon_trolls_1", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_nur_mon_spawn_of_nurgle_0", 2);
          random_army_manager:add_unit("chaos_treasure_force", "wh3_main_sla_mon_spawn_of_slaanesh_0", 2);

          random_army_manager:add_unit("chaos_treasure_force", "wh_main_chs_art_hellcannon", 2);
     elseif turn > 15 and turn < 21 then
          army_size = 18
          -- C Tier
     ...
     invasion_1:start_invasion(function(self)
          ...
          core:add_listener("chaos_treasure_encounter_engage", "FactionLeaderDeclaresWar", true, function(context)
...
cm:add_saving_game_callback(function(context) cm:save_named_value("items_poi_alt", items_poi_alt, context) end)

cm:add_loading_game_callback(function(context) items_poi_alt = cm:load_named_value("items_poi_alt", items_poi_alt, context) end)
