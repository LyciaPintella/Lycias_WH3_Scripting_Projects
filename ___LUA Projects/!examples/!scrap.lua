...
local function mon_asc_ror()
	...
	if cm:get_saved_value("custom_ror_enabled_mon") == nil then
        ...
        --Slanesh und Chaos
            ...
            {faction_key = "wh2_main_def_cult_of_pleasure", unit = "Tdv", merc_pool = "renown", count = 1, rcp = 100, munits = 10, murpt = 0.1, xplevel = 0, frr = "", srr = "", trr = "", replen = true, merc_group = "wh2_main_def_cult_of_pleasure"},
            {faction_key = "wh2_main_def_hag_graef", unit = "Tdv", merc_pool = "renown", count = 1, rcp = 100, munits = 10, murpt = 0.1, xplevel = 0, frr = "", srr = "", trr = "", replen = true, merc_group = "wh2_main_def_hag_graef"},
        --Cathai
