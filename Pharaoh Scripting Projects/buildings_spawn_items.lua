...
local building_spawn_chance = {
     --["building_id"] = number
     ["phar_main_all_resource_production_bronze_mine_derivative_type_a_2"] = 1,
     ["phar_main_all_province_management_main_building_poc_legitimacy_influence_boost_3"] = 1,
     ["phar_main_all_province_management_main_building_poc_happiness_boost_1"] = 1,
     ["phar_main_all_landmark_production_boost_tarsus_1"] = 5,
     ["phar_main_all_province_management_growth_type_a_3"] = 1,
     ["phar_map_bab_province_management_happiness_growth_type_a_3"] = 1,
     ["phar_main_all_resource_production_port_coast_2"] = 1,
     ["phar_main_all_resource_production_modifier_gold_3"] = 1,
     ["phar_main_tausret_resource_production_modifier_gold_3"] = 1,
     ["phar_main_all_resource_production_port_coast_derivative_type_a_1"] = 1,
     ["phar_main_all_resource_production_stone_mine_derivative_type_a_1"] = 1,
     ["phar_main_irsu_resource_production_stone_mine_derivative_type_a_1"] = 1,
     ["phar_main_all_province_management_roads_3"] = 1,
     ["phar_map_bab_province_management_influence_roads_type_a_3"] = 1,
     ["phar_map_myc_province_management_roads_3"] = 1,
     ["phar_sea_peleset_province_management_movement_production_boost_3"] = 1,
     ["phar_main_all_resource_production_gold_mine_derivative_type_b_1"] = 1,
     ["phar_main_irsu_resource_production_gold_mine_derivative_type_b_1"] = 1,
     ["phar_main_all_province_management_happiness_type_c_3"] = 1,
     ["phar_main_ram_province_management_production_boost_happiness_3"] = 1,
     ["phar_main_all_resource_production_modifier_food_3"] = 1,
     ["phar_main_tausret_resource_production_modifier_food_3"] = 1,
     ["phar_main_all_resource_production_fruit_oasis_derivative_type_a_1"] = 2,
     ["phar_main_irsu_resource_production_fruit_oasis_derivative_type_a_1"] = 2,
     ["phar_main_all_military_native_type_a_kush_4"] = 1,
     ["phar_main_all_military_native_type_a_nubia_4"] = 1,
     ["phar_map_all_military_native_type_a_haltamti_4"] = 1,
     ["phar_map_all_military_native_type_a_mat_assur_4"] = 1,
     ["phar_map_all_military_native_type_a_mat_tamti_4"] = 1,
     ["phar_main_religion_cult_center_grand_temple_amun_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_anubis_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_arinna_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_asherah_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_aten_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_baal_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_el_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_horus_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_isis_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_kumarbi_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_kurunta_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_moloch_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_osiris_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_ptah_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_ra_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_set_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_shaushka_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_tarhunz_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_thoth_1"] = 2,
     ["phar_main_religion_cult_center_grand_temple_yamm_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_aphrodite_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_apollo_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_ares_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_ashur_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_inshushinak_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_ishtar_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_marduk_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_ninurta_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_poseidon_1"] = 2,
     ["phar_map_religion_cult_center_grand_temple_zeus_1"] = 2,
     ["phar_main_all_resource_production_modifier_bronze_3"] = 1,
     ["phar_main_tausret_resource_production_modifier_bronze_3"] = 1,
     ["phar_main_amenmesse_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_bay_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_canaan_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_hatti_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_irsu_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_kemet_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_kuru_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_kurunta_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_ramesses_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_seti_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_suppiluliuma_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_tausret_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_achean_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_ash_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_bab_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_elam_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_luwian_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_meso_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_mycenae_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_thracian_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_urartu_military_administration_unit_training_type_b_1"] = 1,
     ["phar_map_wilusa_military_administration_unit_training_type_b_1"] = 1,
     ["phar_main_all_resource_production_wood_canaan_type_a_derivative_1"] = 1,
     ["phar_main_all_resource_production_wood_hatti_derivative_2"] = 1,
     ["phar_map_all_resource_production_wood_mesopotamia_type_a_derivative_1"] = 1,
     ["phar_map_wood_production_aegean_derivative_1"] = 1,
     ["phar_map_wood_production_assuwa_derivative_1"] = 1,
     ["phar_map_wood_production_thrace_derivative_1"] = 1,
}
