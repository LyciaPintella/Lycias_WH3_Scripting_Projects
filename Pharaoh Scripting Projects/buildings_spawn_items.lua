...
local building_spawn_chance = {
     ...
     ["phar_main_all_resource_production_fruit_oasis_derivative_type_a_1"] = 4,
     ["phar_main_irsu_resource_production_fruit_oasis_derivative_type_a_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_amun_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_anubis_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_arinna_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_asherah_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_aten_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_baal_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_el_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_horus_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_isis_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_kumarbi_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_kurunta_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_moloch_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_osiris_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_ptah_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_ra_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_set_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_shaushka_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_tarhunz_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_thoth_1"] = 4,
     ["phar_main_religion_cult_center_grand_temple_yamm_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_aphrodite_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_apollo_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_ares_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_ashur_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_inshushinak_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_ishtar_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_marduk_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_ninurta_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_poseidon_1"] = 4,
     ["phar_map_religion_cult_center_grand_temple_zeus_1"] = 4,
     ["phar_main_all_landmark_production_boost_tarsus_1"] = 6,
}
